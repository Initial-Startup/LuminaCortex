  ...
  return (
    <>
      <section className="mt-30 pt-5 h-auto dark:bg-black bg-white">
        <div className="h-[40rem] w-full rounded-md dark:bg-black bg-white relative flex flex-col justify-center antialiased">
          <div className="flex flex-row relative">
            ...
            <div className="max-h-full left-48 max-w-c-1154 relative 2xl:-mr-7.5">
              <Image
                ...
                width={46}
                height={246}
                className="w-full h-[30rem] left-30 bottom-0 z-999"
              />
            </div>
          </div>
        ...
        <div className="flex flex-row flex-wrap gap-4">
          {/* card -1 */}
          <CardContainer className="inter-var mx-18">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
              ...
              >
                Improve loading times and overall speed.
                Optimize backend processes for faster data handling.</CardItem>
          ...
          <CardContainer className="inter-var mx-18">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
              ...
              <CardItem
                ...
                className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
              >
                Ensure compatibility across all devices (desktops, tablets, and smartphones).
                Implement modern, user-friendly interfaces.</CardItem>
              <CardItem translateZ="100" className="w-full mt-4">
                <Image
          ...
          <CardContainer className="inter-var mx-18">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
              ...
              <CardItem
                ...
                className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
              >
                Update outdated code to current standards.
                Integrate the latest technologies and frameworks. </CardItem>
              <CardItem translateZ="100" className="w-full mt-4">
                <Image
          ...
          <CardContainer className="inter-var mx-18">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
              ...
              <CardItem
                ...
                className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
              >
                Redesign the user interface for better navigation and usability.
                Ensure accessibility compliance for all users. </CardItem>
              <CardItem translateZ="100" className="w-full mt-4">
                <Image
          ...
          <CardContainer className="inter-var mx-18">
            <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
              ...
              <CardItem
                ...
                className="text-neutral-500 text-sm max-w-sm mt-2 dark:text-neutral-300"
              >
                Enhance security measures to protect against modern threats.
                Regular updates and maintenance for continued protection.  </CardItem>
              <CardItem translateZ="100" className="w-full mt-4">
                <Image
